        ...
        {syllabus_sections.map((section, index) => (
          <div key={section.id} className="flex items-center gap-3 flex-1">
             <div className={cn(
                 ...
                 section.is_completed ? "opacity-100" : "opacity-50 hover:opacity-80"
             )}>
                 <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold uppercase tracking-wider truncate max-w-[120px]" title={section.title}>
                 ...
                 <div className="h-1 w-full bg-white/10 rounded-full overflow-hidden">
                     <div className={cn(
                         ...
                         section.is_completed ? "bg-[var(--color-primary)] w-full" : "bg-white/20 w-0"
                     )} />
                 </div>
             </div>
